...
const spPlaylists: SPPlaylist[] = [
  { id: 'sp-raavfy', name: 'Raavfy Songs', cover: spRaavfyCover, accentColor: '#7c3aed', textColor: '#ede9fe',
    ...
    tracks: [
      { title: 'Kau Pilih Dia', artist: 'Raavfy, Mas Jordan, Malikoendang', duration: '4:01', trackId: '4EzaRRchzCQ2iRpWtbjBwD' },
  ...
  { id: 'sp-english', name: 'English Songs', cover: spEnglishCover, accentColor: '#0ea5e9', textColor: '#e0f2fe',
    ...
    tracks: [
      { title: 'Those Eyes', artist: 'New West', duration: '3:40', trackId: '50x1Ic8CaXkYNvjmxe3WXy' },
      { title: 'Cut My Fingers Off', artist: 'Ethan Bortnick', duration: '2:19', trackId: '5ARrWiDDRDocvURbemcnCy' },
      { title: 'From The Start', artist: 'Laufey', duration: '2:49', trackId: '43iIQbw5hx986dUEZbr3eN' },
    ],
  },
  { id: 'sp-jkt48', name: 'JKT48 Songs', cover: spJkt48Cover, accentColor: '#e11d48', textColor: '#fce7f3',
    ...
    tracks: [
      { title: 'Sahabat atau Cinta', artist: 'JKT48', duration: '4:06', trackId: '6gmPSVwfO97scRd3UnDCUz' },
      { title: 'Dai Dai Dai', artist: 'JKT48', duration: '3:34', trackId: '6LcRqI57FUeEXgLD9fnegZ' },
  ...
  { id: 'sp-indonesia', name: 'Indonesia Songs', cover: spIndonesiaCover, accentColor: '#d97706', textColor: '#fef3c7',
    ...
    tracks: [
      { title: 'Di Batas Malam', artist: 'Danilla', duration: '4:25', trackId: '57wJkQVl4krsMHaowArNgc' },
      { title: 'Pecinta Wanita', artist: 'Irwansyah', duration: '4:13', trackId: '0sMclGmddV8xeqBgI2k2yB' },
      { title: 'Monolog', artist: 'Pamungkas', duration: '3:27', trackId: '1zu5ZpnrSArdoaT6Qq3yo9' },
    ],
  },
];
